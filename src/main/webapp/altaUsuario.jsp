        ...
        <form name="formAlta" action="Controller?opID=DarAltaUsuario" method="POST">
            <fieldset>
                ...
                <div class="camposForm">
                    <input type="radio" name="roles" value="0" id="admin"/><label for="admin">Administrador</label>
                    <input type="radio" name="roles" value="1" id="arr" checked="checked" /><label for="arr">Arrendador</label>
                </div>
            </fieldset>
            <fieldset>
